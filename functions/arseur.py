...
async def arseur(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        # Obtener el valor en ARS desde los argumentos
        string_number = context.args[0].replace("/arseur ", "")
        ...
        formatted_message.append(
            ...
            f"            -> {float_number:,.2f} ARS - {float_number / float(euro_data.get('venta')):,.2f} EUR:\n"
